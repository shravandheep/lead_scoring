...
for enc in L1_LBL_ENC:
    ...
    try:
        ...
        if response.status_code == 200:
            print('Encoder downloaded successfully. Proceeding to saving the {} locally'.format(enc))
            ...
            local_path = os.path.realpath(os.path.join(_FILE_PATH, ENC_PATH, LBL_ENC_PATH, file_name))
...
for enc in L1_SCL_ENC:
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            local_path = os.path.realpath(os.path.join(_FILE_PATH, ENC_PATH, SCL_ENC_PATH, file_name))
