...
class Groups_Regex(Plugin):
    ...
    def get_url_group(self, url):
        ...
        for class_name, pattern in patterns.items():
            ...
            mapped_1 = any([is_word_in_list(word, wordlist, 'match') for word in pattern['match']])
            mapped_2 = any([is_word_in_list(word, wordlist, 'freeflow') for word in pattern['freeflow']])
